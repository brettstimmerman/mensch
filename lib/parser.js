...
function parseToken(token) {
  ...
  case 'font-face':
  case 'supports' :
  case 'viewport' : return parseAtGroup(token);
  }
 ...
 */
function parseTokensUntil(conditionFn) {
  var node;
  var nodes = [];
  var token;
...
function parseDeclarations() {
  return parseTokensUntil(function (token) {
 ...
 */
function parseRules() {
  return parseTokensUntil(function () { return _depth; });
}
